...
// Insert PRN–Name pairs
populationMap.insert(pair<int, string>(1093, "Siddiqa"));
populationMap.insert(pair<int, string>(1111, "A"));
populationMap.insert(pair<int, string>(2222, "B"));
populationMap.insert(pair<int, string>(3333, "C"));
populationMap.insert(pair<int, string>(4444, "D"));
populationMap.insert(pair<int, string>(5555, "E"));
